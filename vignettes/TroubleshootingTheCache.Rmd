...
AnnotationHub, to continue using the created cache, must move the cache and its
...
oldcache = path.expand(rappdirs::user_cache_dir(appname="AnnotationHub"))
...
newcache = tools::R_user_dir("AnnotationHub", which="cache")
