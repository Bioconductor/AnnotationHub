...
into the NAMESPACE (rememeber that this is that string you are providing as your 1st argument), and then add this code to the AnnotationHubData repository.  We are planning to set up a bridge to github so that you can give us a pull request.  
